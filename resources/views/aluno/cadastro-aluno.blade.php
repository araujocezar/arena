                                    ...
                                    <div class="form-column">
                                        <div class="form-row">
                                            ...
                                            <div class="col-5">
                                                ...
                                                <input type="text" minlength="14" maxlength="14" class="form-control" id="cpfmask" name="cpf" value="{{ $aluno->cpf ?? '' }}" required>
                                        ...
                                        <div class="form-row" style="margin-top: 12px;">
                                            <div class="col-5">
                                                ...
                                                <input type="text" id="telefonemask" name="telefone" class="form-control" value="{{ $aluno->telefone ?? '' }}" pattern="\([0-9]{2}\)[\s][0-9]{4}-[0-9]{4,5}">
                                                <script type="text/javascript">
                                        ...
                                        <div class="form-row" style="margin-top: 12px;">
                                            <div class="col-3">
                                                <div class="container">
                                                    ...
                                                    <input class="form-control" id="datepicker" type="text" name='data_cadastro' value="{{ $aluno->data_cadastro ?? '' }}" required>
                                                </div>
                                                <script type="text/javascript">
